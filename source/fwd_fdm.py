...
class FDMCrankNicolsonNeumann():
    def __init__(self, _x_min, _x_max, _J, _t_min, _t_max, _N, _calibbasket, _init_condition):
        self.x_min = _x_min
        self.x_max = _x_max
        self.J = _J
        self.t_min = _t_min
    ...
    def set_initial_conditions(self):
        ...
        self.prev_t = 0
        self.cur_t = 0
        self.zeta = self.calibbasket.loc_vol.interpolate(self.x_values) ** 2 / (4 * self.dx ** 2)
